...
## Environments
- Preview: https://main--Aem-Eds-Froms-Practice--bhanuprakashgowd.hlx.page/
- Live: https://main--Aem-Eds-Froms-Practice--bhanuprakashgowd.hlx.live/
...
1. Open the `Aem-Eds-Froms-Practice` directory in your favorite IDE and start coding :)
